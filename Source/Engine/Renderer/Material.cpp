...
namespace nc
{
	...
	void Material::ProcessGui()
	{
		...
		Gui::GetDialogResource<Texture>("AlbedoTextureDialog", "Open Texture", "Image file (*.png;*.jpg;*.jpeg;*.bmp;*.tga){.png,.jpg,.jpeg,.bmp,.tga},.*");
		...
		Gui::GetDialogResource<Texture>("SpecularTextureDialog", "Open Texture", "Image file (*.png;*.jpg;*.jpeg;*.bmp;*.tga){.png,.jpg,.jpeg,.bmp,.tga},.*");
		...
		Gui::GetDialogResource<Texture>("EmissiveTextureDialog", "Open Texture", "Image file (*.png;*.jpg;*.jpeg;*.bmp;*.tga){.png,.jpg,.jpeg,.bmp,.tga},.*");

		//normal
		ImGui::Text("Normal");
		(normalTexture) ? ImGui::Text("%s", normalTexture->name.c_str()) : ImGui::Text("None");
		Gui::GetDialogResource<Texture>("NormalTextureDialog", "Open Texture", "Image file (*.png;*.jpg;*.jpeg;*.bmp;*.tga){.png,.jpg,.jpeg,.bmp,.tga},.*");
